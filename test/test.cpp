...
int main(int argc, char const *argv[]) {
  ...
  //     if (!(ss >> vec_num[cnt])) {
  //       std::cerr << "The name should be number. Error encountered,
  //       exiting...\n"; return 1;
  //     }
  //     if (!(ss >> vec_ext[cnt])) {
  //       std::cerr
  //           << "The extension should be string. Error encountered,
  //           exiting...\n";
  //       return 1;
  //     }
  //     ++cnt;
  ...
  //   } else if (vec_ext[0] + vec_ext[1] == ".png.txt") {
  ...
  //     return 1;
  //   }
  //   std::cout << "The output is" << output_num;
  return 0;
}